...
- `.gemini/` — where this file's own rules sections live, folded in directly since Gemini only auto-loads a file literally named `GEMINI.md`, not an arbitrary folder
