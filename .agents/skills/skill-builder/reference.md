...
4. **Invoke directly** -- Run `/skills` to browse and pick it by hand, or type `$skill-name` to mention it directly (for example, `$skill-creator`), to confirm the skill works at all.
